    ...
    public partial class AddIdentityAndAuthorization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_organization_scopes", x => x.id);
                    table.ForeignKey(
                        name: "fk_user_organization_scopes_asp_net_users_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_organization_scopes_organizations_organization_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_organization_scopes_organization_id",
                table: "user_organization_scopes",
                column: "organization_id");

            migrationBuilder.CreateIndex(
                name: "ix_user_organization_scopes_user_id_organization_id",
                table: "user_organization_scopes",
